...
export const VendorBuyTable = (props) => {
              ...
              {items.map((sub, i) => {
                ...
                return (
                  <TableRow hover key={sub.id} selected={isSelected}>
                    ...
                    <TableCell sx={{ textAlign: "center" }}>{sub.userName}</TableCell>
                  
                    <TableCell sx={{ textAlign: "center" }}>{sub.email}</TableCell>
